      ...
      <SectionWrapper>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {room.amenities.map((amenity, index) => (
                          <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-lg border border-stone-100">
                              <Check size={18} className="text-purple-800" />
              ...
              <div className="lg:col-span-1">
                  <div className="bg-white p-8 rounded-xl shadow-lg border border-stone-100 sticky top-24">
                      <h3 className="text-xl font-serif font-bold mb-6">Book Your Stay</h3>
                      <form className="space-y-4">
                          <div>
                              <label className="block text-xs uppercase tracking-wider text-stone-500 mb-2">Check-in</label>
                              <input type="date" className="w-full p-3 border border-stone-200 rounded-md focus:ring-1 focus:ring-purple-500 outline-none text-stone-700" />
                          </div>
                          <div>
                          ...
                          <div>
                              ...
                              <select className="w-full p-3 border border-stone-200 rounded-md focus:ring-1 focus:ring-purple-500 outline-none text-stone-700 bg-white">
