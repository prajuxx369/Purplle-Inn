...
const usps = [
  {
    ...
    image: "https://images.unsplash.com/photo-1449156001533-cb39c85244f0?q=80&w=2070&auto=format&fit=crop",
  },
  {
    icon: Star,
...
export function USPs() {
  return (
    <SectionWrapper className="bg-transparent overflow-visible">
